...
- Use workflowAction: "special_finalize" when presenting presentation format options (narrative/tabular/mixed)
...
- A brief summary of the results' presentation format and key findings — mention the presentation method chosen, main findings covered, and data scope so the context window retains what was decided (not the full artifact content)
