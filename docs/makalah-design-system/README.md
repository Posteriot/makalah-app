...
| 2 | **[global-css.md](docs/global-css.md)** | Konfigurasi variabel CSS & Tailwind v4 `@theme`. |
...
| 5 | **[shape-layout.md](./shape-layout.md)** | Aturan radius (Hybrid), border hairline, & 16-col grid. |
...
2.  **Verify Tokens**: Pastikan variabel CSS yang Anda gunakan sudah terdaftar di `global-css.md`.
...
6.  **shadcn Usage**: Komponen shadcn akan otomatis menggunakan tema ini karena variabel dasar (`--background`, `--primary`, dll) sudah di-map di `global-css.md`.
