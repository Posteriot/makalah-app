...
3. Start with Priority 1 (Google Grounding chain swap) — it's a DB config change, instant win
4. Then Priority 2 (.ac.id routing) — one file change
5. Priorities 3-6 are UI/client work, can be batched
