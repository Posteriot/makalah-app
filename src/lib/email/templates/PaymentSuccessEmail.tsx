...
interface PaymentSuccessEmailProps {
  ...
  newTotalCredits?: number // Total credits after purchase
...
export function PaymentSuccessEmail({
  ...
  const formattedCredits = credits ? `${credits} kredit` : "-"
  const formattedTotalCredits = newTotalCredits ? `${newTotalCredits} kredit` : "-"

  return (
    <EmailLayout preview={`Pembayaran ${formattedAmount} berhasil - kredit baru: ${formattedTotalCredits}`}>
      {/* Greeting */}
      ...
      <Section style={detailsBox}>
        ...
        <Text style={detailValue}>{formattedCredits}</Text>

        <Text style={detailLabel}>Total Kredit Anda</Text>
        <Text style={detailValueHighlight}>{formattedTotalCredits}</Text>
