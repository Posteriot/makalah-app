 ...
 * Design matches mockup: transparent bg with subtle orange border
 */
export function PawangBadge() {
  return (
    ...
    >
      <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-black/20 backdrop-blur-sm border border-[rgba(232,102,9,0.4)] transition-all duration-300 hover:translate-y-[-2px] hover:bg-black/30 hover:border-[rgba(232,102,9,0.6)] hover:shadow-[0_0_20px_rgba(232,102,9,0.2)]">
        {/* Animated orange dot */}
