...
export function ManifestoSectionCMS({ content }: ManifestoSectionCMSProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative isolate box-border bg-background md:min-h-[100svh] md:overflow-hidden"
    ...
    >
      ...
      <div className="relative z-[1] mx-auto flex w-full max-w-[var(--container-max-width)] items-start px-4 py-8 md:min-h-[100svh] md:items-center md:px-6 md:py-20">
