...
export async function sendWaitlistInviteEmail(
  ...
  await sendViaResend(
    ...
    `<div style="font-family: 'Geist Sans', -apple-system, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px 24px; background: #0f172a; color: #e2e8f0; border-radius: 8px;">
      ...
      <p style="font-size: 13px; color: #cbd5e1; margin: 0 0 24px 0;">Giliran kamu sudah tiba! Klik tombol di bawah untuk mendaftar di Makalah AI. Kamu bisa pilih masuk lewat Google atau daftar dengan email dan password.</p>
      ...
      <p style="font-size: 11px; color: #64748b; margin: 0 0 8px 0;">Data kamu sudah kami siapkan di form pendaftaran — tinggal pilih metode masuk.</p>
