export const STAGE_KEY_WHITELIST: Record<string, string[]> = {
    ...
    daftar_pustaka: [
        "entries", "totalCount", "incompleteCount", "duplicatesMerged",
        "webSearchReferences", "artifactId", "validatedAt", "revisionCount"
    ],
    lampiran: [
        "items", "tidakAdaLampiran", "alasanTidakAda",
        "webSearchReferences", "artifactId", "validatedAt", "revisionCount"
    ],
    judul: [
        "opsiJudul", "judulTerpilih", "alasanPemilihan",
        "webSearchReferences", "artifactId", "validatedAt", "revisionCount"
    ],
};
